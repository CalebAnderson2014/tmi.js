                ...
                case "USERNOTICE":
                    if (msgid === "resub") {
                        ...
                        this.emits(["resub", "subanniversary"], [
                            [channel, username, msg, userstate, {prime, plan, planName}, months],
                            [channel, username, msg, userstate, {prime, plan, planName}, months]
                        ]);
                    }
                    ...
                    // Handle sub
                        ...
                        this.emit("subscription", channel, username, msg, userstate, {prime, plan, planName}, months);
                    }
                    break;
                    ...
                    if (message.tags.username === "jtv") {
                        ...
                        if (msg.match(/^\u0001ACTION ([^\u0001]+)\u0001$/)) {
                            ...
                            if (message.tags.hasOwnProperty("bits")) {
                                this.emit("cheer", channel, message.tags.username, message.tags, msg);
                            }
